...
public class RecipeResourceIntTest {
    ...
    private static final String DEFAULT_STEP_BY_STEP = "AAAAAAAAAA";
    private static final String UPDATED_STEP_BY_STEP = "BBBBBBBBBB";
    ...
    public void createRecipe() throws Exception {
        ...
        assertThat(testRecipe.getStepByStep()).isEqualTo(DEFAULT_STEP_BY_STEP);
    ...
    public void getAllRecipes() throws Exception {
        ...
        restRecipeMockMvc.perform(get("/api/recipes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].stepByStep").value(hasItem(DEFAULT_STEP_BY_STEP.toString())))
    ...
    public void getRecipe() throws Exception {
        ...
        restRecipeMockMvc.perform(get("/api/recipes/{id}", recipe.getId()))
            ...
            .andExpect(jsonPath("$.stepByStep").value(DEFAULT_STEP_BY_STEP.toString()))
    ...
    public void updateRecipe() throws Exception {
        ...
        updatedRecipe
            .title(UPDATED_TITLE)
            .stepByStep(UPDATED_STEP_BY_STEP)
        ...
        assertThat(testRecipe.getStepByStep()).isEqualTo(UPDATED_STEP_BY_STEP);
